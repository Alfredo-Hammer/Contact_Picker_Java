package com.hammer67.pickcontactjava;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void requestContactPersmission(){
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
        ...
        if (requestCode == CONTACT_PERMISSION_CODE){
            if (grantResults.length > 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED){
                ...
                Toast.makeText(this, "Persmiso denegado...", Toast.LENGTH_SHORT).show();
            }
        }
    }
        ...
        if (resultCode == RESULT_OK){
            if (requestCode == CONTACT_PICK_CODE){
                ...
                if (cursor1.moveToFirst()){
                    ...
                    String contactThumail = cursor1.getString(cursor1.getColumnIndex(ContactsContract.Contacts.PHOTO_THUMBNAIL_URI));
                    ...
                    if (idResultHold == 1){
                        ...
                        while (cursor2.moveToNext()){
                            ...
                            if (contactThumail != null){
                                imageView.setImageURI(Uri.parse(contactThumail));
                            }
                            else {
